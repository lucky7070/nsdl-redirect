    ...
    public function run()
    {
        $settings = [
            ...
            [
                ...
                'filed_label'   => 'Meta Description',
                'filed_type'    => 'text',
                'filed_value'   => 'Meta Description',
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
            [
                'setting_type'  => 1,
                'setting_name'  => 'meta_keywords',
                'filed_label'   => 'Meta Keywords',
                'filed_type'    => 'text',
                'filed_value'   => 'Meta Keywords',
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
            [
                ...
                'filed_type'    => 'text',
                'filed_value'   => 'Copyright © 2023. All rights reserved.',
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
            [
            ...
            [
                ...
                'filed_type'    => 'text',
                'filed_value'   => 'https://www.linkedin.com',
                'created_at'    => Carbon::now(),
                'updated_at'    => Carbon::now(),
            ],
            [
